defmodule AnchorWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnchorWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnchorWeb.Gettext, "errors", msg, opts)
    end
  end
